...
def transaction_page():
    ...
    total = amount * 100 * price  # 1 lot = 100 lembar
    ...
    # Tampilkan saldo dan riwayat singkat
    st.write(f"Saldo Setelah Transaksi: Rp {st.session_state.balance:,}")
